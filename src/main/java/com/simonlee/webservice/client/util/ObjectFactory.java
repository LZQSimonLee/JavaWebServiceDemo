 ...
 * element interface generated in the com.simonlee.webservice.client.util
 * package.
 * <p>
...
public class ObjectFactory {
	private final static QName _GetName_QNAME = new QName(
			"http://main.server.webservice.simonlee.com/", "getName");
	private final static QName _GetNameResponse_QNAME = new QName(
			"http://main.server.webservice.simonlee.com/", "getNameResponse");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: com.simonlee.webservice.client.util
	 * 
	 */
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://main.server.webservice.simonlee.com/", name = "getName")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://main.server.webservice.simonlee.com/", name = "getNameResponse")
